...
//        Page<Product> products = this.productRepository.findAllByPriceAndCategory(2.0,category.get(),pageable);

//        List<Product> products = productRepository.findAllByPriceAndCategory(2.0,category.get(),pageable).getContent();
//        products.forEach(System.out::println);

//        List<Product>products1 = productRepository.findAllByManufactureInAndCategoryAndColorAndPrice(manufactureSet,null,null,null,pageable).getContent();
//        products1.forEach(System.out::println);

//        List<Product> products = productRepository.findAllByManufactureInAndCategoryAndPrice(manufactureSet,category.get(),null);

//        Page<Product> products =  this.productRepository.findAllByManufactureIn(manufactureSet,pageable);
//        products.and(productRepository.findAllByCategory(category.get(),pageable));
//        products.and(productRepository.findProductByPrice(2.0, pageable));
